...
| **SB2 WIFI** | Sensorbox wifi *(Only available if MAINS METER is set to **Sensorbox**, requires Sensorbox v2)* | **Disabled** No wifi connection.<br/><br/>**SetupWifi** Once the Sensorbox2 is connected to your Wifi, you can find it's IP address on the SmartEVSE's SB2 WIFI menu option; connect with your phone to that access point, goto http://192.168.4.1/ and configure your Wifi password.<br/><br/>**Enabled** Connect to the previosly setup Wifi.
