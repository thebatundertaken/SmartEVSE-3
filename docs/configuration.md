...
| **SOL BOOST** | Exceed MAINS MAX capacity using solar surplus *(Only available in Smart mode and if MAINS METER is in use)*. Useful in 3 phases installations with 1 phase cable and solar panels. | 
